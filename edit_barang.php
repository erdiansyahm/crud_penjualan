...
?>
 ...
 <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form method="POST" action="edit_proses_barang.php" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
                   ...
                   <div class="col-sm-6">
					...
					<div class="col-sm-2">
					<button type="submit" name="edit" class="btn btn-block btn-success btn-sm">Simpan</button>
					</div>
					 </div>
                  <!-- input states -->
