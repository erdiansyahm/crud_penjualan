...
$pdf->Cell(60,6,'Harga',1,0,'C');
$pdf->Cell(22,6,'Stok',1,1,'C');
...
$pdf->Cell(60,6,$hasil['nama_barang'],1,0,'L');
$pdf->Cell(60,6,'Rp. '.number_format($hasil['harga'],2,",","."),1,0,'C');
$pdf->Cell(22,6,$hasil['stok'],1,1,'C');
