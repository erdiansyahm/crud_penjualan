...
<?php
	...
	include "koneksi.php";
	$id=$_GET['$id'];
	$query=mysqli_query($db,"SELECT * FROM pembelian where id='$id_beli ");
...
?>
 ...
 <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form method="POST" action="edit_proses_beli.php" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
                      
                    
						 <input type="hidden" class="form-control" name="id_beli" value="<?php echo "$data[id_beli]" ?> ">
