...
<head>
  ...
  <title>Erdiansyah | Pembelian</title>
...
<h<div class="card card-warning">
                ...
                <form method="POST" action="proses_beli.php" enctype="multipart/form-data" >
                  ...
                  <label>Tanggal Beli:</label>
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input" name = 'tgl_beli' data-target="#reservationdatereservationdate"/>
			...
			$query=mysqli_query($db,"SELECT * FROM barang,pembelian where barang.kode_barang=pembelian.kode_barang order by id_beli DESC");
