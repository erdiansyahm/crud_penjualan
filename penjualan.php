...
<head>
  ...
  <title>Erdiansyah | Penjualan</title>
...
<h<div class="card card-warning">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form method="POST" action="proses_jual.php" enctype="multipart/form-data" >
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
                  ...
                  <label>Tanggal Jual:</label>
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input" name = 'tgl_jual' data-target="#reservationdatereservationdate"/>
			...
			$query=mysqli_query($db,"SELECT * FROM barang,penjualan where barang.kode_barang=penjualan.kode_barang order by id_jual DESC");
