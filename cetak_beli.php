...
$gt=0;
$no=1;
$tampil=mysqli_query($db,"Select * from barang,pembelian Where barang.kode_barang = 
pembelian.kode_barang and tgl_beli between '$_POST[dari]' and '$_POST[sampai]'");
...
$pdf->Cell(25,6,'Rp. '.number_format($total,2,",","."),1,1,'C');
$gt += $total;

}
$pdf->SetFont('Arial','B',10);
$pdf->Cell(164,7,'Grand Total','LBR',0,'C','0');
$pdf->Cell(25,7,'Rp. '.number_format($gt,2,",","."),1,1,'C');
