...
<div class="card card-warning">
			...
			<?php
				...
				$query=mysqli_query($db,"SELECT * FROM barang order by id DESC");
			    ...
			    ?>
					...
					echo "<a href='edit_barang.php?id=$data[id]' class='btn btn-warning btn-xs'><i class='fa fa-pencil'></i> Edit</a>";
					echo "<a href='hapus.php?id=$data[id]' class='btn btn-warning btn-xs'><i class='fa fa-pencil'></i> Delete</a>";
